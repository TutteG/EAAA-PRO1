...
public class CompanyPane extends GridPane {
	...
	private void addCustomerAction() {
		...
		CustomerWindow dia = new CustomerWindow("Add Customer", company);
		dia.showAndWait();
	...
	public void updateControls() {
		...
		if (company != null) {
			...
			for (Customer customer : company.getCustomers()) {
				customerSB.append(customer.getName() + "\n");
			}
			txaEmps.setText(sb.toString());
			txaCustomers.setText(customerSB.toString());
		} else {
			txfName.clear();
			txfHours.clear();
			txaEmps.clear();
