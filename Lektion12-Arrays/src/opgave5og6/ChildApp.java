...
public class ChildApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("Institutionens navn:		" + elmegaarden.getName());
		System.out.println(elmegaarden.getName() + "'s addresse:		" + elmegaarden.getAddress());
		System.out.println("Drenge i " + elmegaarden.getName() + ":		" + elmegaarden.boysCount());
		System.out.println("Piger i " + elmegaarden.getName() + ":		" + elmegaarden.girlsCount());
		System.out.println("Gennemsnitsalder i børnehaven:	" + elmegaarden.gennemsnitsalder());
		System.out.println("Der er indskrevet i " + elmegaarden.getName() + ":	" + elmegaarden.getNumberOfChildren());
