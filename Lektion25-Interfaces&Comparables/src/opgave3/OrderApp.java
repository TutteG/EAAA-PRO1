...
public class OrderApp {
	public static void main(String[] args) {
		...
		int age = LocalDate.now().getYear() - customer1.getBirthday().getYear();
		...
		Discount ageDiscount = new AgeDiscount(order1.getOrderPrice(), age);
		customer1.setDiscount(ageDiscount);
		System.out.println(customer1.getDiscountedPrice(order1));
